...
// so in order to get the voices and not an empty array
// if the onvoiceschanged is not undefined, set this to the getVoices function.
getVoices();
